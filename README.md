...
The code is fixed as of April 2025 and should correspond to the comments made in the print version of that article.
...
hosts the files representative_scales, representative_signvectors, and color_adjacencies. Because these are large, they need
...
* Rather than following the instructions of footnote 7, follow `musicMCT`'s installation instructions in its readme file.
* Footnote 43 refers to `ineqmats.rds`, but the inequality matrices are contained inside the package `musicMCT` and don't need to be downloaded separately.
